...
KONFLUX_IMAGE_BUILD_PLR_TEMPLATE_URL_FORMAT = "https://api.github.com/repos/openshift-priv/art-konflux-template/contents/.tekton/art-konflux-template-push.yaml?ref=ci/replace-clair-with-rox-scan"  # Konflux PipelineRun (PLR) template for image builds
KONFLUX_BUNDLE_BUILD_PLR_TEMPLATE_URL_FORMAT = "https://api.github.com/repos/openshift-priv/art-konflux-template/contents/.tekton/art-bundle-konflux-template-push.yaml?ref=ci/replace-clair-with-rox-scan"  # Konflux PipelineRun (PLR) template for bundle builds
KONFLUX_FBC_BUILD_PLR_TEMPLATE_URL_FORMAT = "https://api.github.com/repos/openshift-priv/art-konflux-template/contents/.tekton/art-fbc-konflux-template-push.yaml?ref=ci/replace-clair-with-rox-scan"  # Konflux PipelineRun (PLR) template for FBC builds
